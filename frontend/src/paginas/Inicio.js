            ...
            <body >
                ...
                <div class="section-three">
                    <div className='section-sub-one'>
                        ...
                        <img className='img-one-home' src={require("../imgs/astronauta.png")} alt="Astronauta" />
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                ...
                <div class="section-four">
                    <div className='section-sub-two'>
                        ...
                        <div className='section-mini-two'>
                            <h1>¡Descubre el Universo en CosmiConnect!</h1>
                            <p className='p-pink'>Descubre el espacio como nunca antes. Horóscopos, planetas, estrellas y satélites, todo en un solo lugar. Únete a nosotros y despierta tu pasión por el universo.</p>
                            <div className='container-btn-home'>
                                <Link to="/login"><button type="submit" className="btn-login">
                                    ¡Comienza ahora!
                                </button>
